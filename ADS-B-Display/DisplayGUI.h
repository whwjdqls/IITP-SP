...
__published:	// IDE-managed Components
	...
	TLabel *Label20;
	TLabel *RouteLabel;
	TSpVoice *SpVoice1; // TODO: Replace with Google Cloud speech client wrapper.
	TSpSharedRecoContext *SpSharedRecoContext1; // TODO: Remove when Google Cloud Speech replaces SAPI.
	TMemo *Memo1;
	TMenuItem *LIsten;
...
private:	// User declarations
    bool __fastcall CaptureMicrophoneAudio(TBytes &buffer, unsigned int durationMs);
    UnicodeString __fastcall BuildGoogleSpeechPayload(const TBytes &audioBytes);
